...
## 16. 예약 진입점 연결 + 브랜딩 통일 (2026-06-13 추가)
...
### 남은 일(이번 작업 범위 밖)
- `/privacy` 초안 → 실제 사업자정보(`site.ts` `business`: 주식회사 짱샘에듀/하성재/711-81-03824)·보유기간 확정.
- 실브라우저 신청→슬롯→무통장 결제 1회 통과(end-to-end, 알림톡 발송 포함) 검증.
