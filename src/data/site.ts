...
export const why = [
  ...
  },
  {
    icon: 'Users',
    title: '부모와 함께하는 치료',
    desc: '정기 상담과 가정 연계 과제, 그리고 50여 권의 전자책으로 센터 밖에서도 함께합니다.',
  },
]
...
export const process = [
  ...
  },
  {
    step: '04',
    title: '치료 진행',
    desc: '발달재활 전문가 짱샘이 1:1 세션을 꾸준히 진행하며 아이의 성장을 이끌어 갑니다.',
  },
  {
    step: '05',
    title: '주기적 재평가·피드백',
...
export const founder = {
  ...
  bio: [
    ...
    '현장에서 얻은 깨달음은 50여 권의 발달 전자책과 아로마·후각 케어 프로그램으로 이어졌습니다. 치료실에 오지 못하는 부모님도 가정에서 아이를 도울 수 있도록, 짱샘은 오늘도 책과 향기로 손을 내밉니다.',
  ],
  credentials: [
    '소아 물리치료사 · 25년 임상',
    '키즈피지오 아동발달센터 센터장',
    '피지오 후각 연구소 소장',
    '발달·호흡·후각 전자책 50여 권 저술',
  ],
}
...
export const team: Therapist[] = [
  {
    name: '장지예 (짱샘)',
    role: '센터장 · 소아 물리치료사',
    tags: ['소아재활 25년', '호흡·후각 통합', '전자책 50여 권 저술'],
    photo: '/team/jjangsaem.png',
  },
]
...
/** 대표작 — 전체 50여 권은 짱샘의 책방(jjangsaem.com)에서 만날 수 있습니다. */
...
export const history = [
  ...
  { year: '짱샘의 책방', text: '발달·호흡·후각·수면·치유 전자책 50여 권 출간' },
]
...
export const faqs = [
  ...
  },
  {
    ...
    a: '발달·호흡·후각·수면·치유 5개 분야의 전자책 50여 권을 만나실 수 있습니다. 터미타임, 원시반사, 사경·사두증, 후각 훈련 등 주제별로 가정에서 바로 활용할 수 있도록 구성했습니다. 책방은 jjangsaem.com에서 운영합니다.',
  },
  {
