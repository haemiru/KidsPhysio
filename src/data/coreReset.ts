...
export const coreResetIntro = {
  greeting: '안녕하세요.',
  body: [
    '브레인센트 코어 리셋 시스템™은 후각·호흡·원시반사·코어 안정성을 기반으로 아이의 신경계 상태를 이해하고, 가정 내 반복 경험을 통해 몸의 안정성과 기능적 움직임 회복을 돕는 부모 참여형 홈케어 코칭 프로그램입니다.',
  ],
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: 'text',
        multiline: true,
        label: '이번 4주 동안 가장 기대하는 변화는 무엇인가요?',
        placeholder: '자유롭게 적어 주세요.',
      },
    ],
  },
